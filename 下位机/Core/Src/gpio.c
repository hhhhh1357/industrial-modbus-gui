...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, AD_CS_Pin|AD_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(AD_STBY_GPIO_Port, AD_STBY_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IIC_SCL_Pin|IIC_SDA_Pin|LED_Pin|LED1_Pin|DS18B20_DQ_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = AD_CS_Pin|AD_RESET_Pin|AD_STBY_Pin;
  ...
  GPIO_InitStruct.Pin = IIC_SCL_Pin|IIC_SDA_Pin|DS18B20_DQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
